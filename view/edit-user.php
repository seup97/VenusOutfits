            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="fname" id="fname" class="form-control" value="<?php echo $userrrow["user_fname"];  ?>"/>
                        </div>
                        <div class="col-md-2">
                              <label class="control-label" >Last Name</label>
                        </div>
                        <div class="col-md-4">
                             <input type="text" name="lname" id="lname" value="<?php echo $userrrow["user_lname"];  ?>" class="form-control"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">&nbsp;</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="email" id="email" class="form-control" value="<?php echo $userrrow["user_email"];  ?>"/>
                        </div>
                        <div class="col-md-2">
                              <label class="control-label" >NIC</label>
                        </div>
                        <div class="col-md-4">
                             <input type="text" name="nic" id="nic" class="form-control" value="<?php echo $userrrow["user_nic"];  ?>"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">&nbsp;</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="cno1" id="cno1" class="form-control" value="<?php echo $userrrow["user_cno1"];  ?>"/>
                        </div>
                        <div class="col-md-2">
                              <label class="control-label" >Contact Mobile</label>
                        </div>
                        <div class="col-md-4">
                             <input type="text" name="cno2" id="cno2" class="form-control" value="<?php echo $userrrow["user_cno2"];  ?>"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">&nbsp;</div>
                        ...
                        <div class="col-md-4">
                            <select class="form-control" id="user_role" name="user_role" required="required">
                                ...
                                <option value="<?php echo $role_row["role_id"] ?>" 
                                            <?php
                                                if($userrrow["role_id"]==$role_row["role_id"])
                                                {
                                            ?>
                                        selected="selected"
                                            <?php
                        ...
                        <div class="col-md-4">
                            <input type="file" name="user_img" id="user_image" class="form-control" onchange="readImage(this);"/>
                             <br/>
                              <?php
                                $userimage="";
                                if($userrrow["user_image"]=="")
                                {
                                    $userimage="defaultImage.jpg";
                                }
                                else{
                                    $userimage=$userrrow["user_image"];
                                }
                             ?>
