            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <table class="table table-striped" id="usertable">
                        <thead>
                            <tr style="background-color:#5db4d4 ;color: #FFF">
                                <th>&nbsp;</th>
                                <th>Name</th>
                                <th>Brand</th>
                                <th>Category</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo ucwords($product_row["product_description"]); ?></td>
                                ...
                                <td>
                                     ...
                                     <a href="view-user.php?user_id=<?php echo $product_id; ?>" class="btn btn-warning"><span class="glyphicon glyphicon-search"></span>&nbsp;Delete</a>
                                </td>
                                <td>
                                   <?php 
                                        if($product_row["product_status"]==1)
                                        {
                                           ?>
                                    <a href="../controller/product_controller.php?status=deactivate&user_id=<?php echo $product_id ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp; Deactivate</a> 
                                           <?php
                                        }
                                        else
                                        {
                                            ?>
                                    <a href="../controller/product_controller.php?status=activate&user_id=<?php echo $product_id ?>" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span>&nbsp; Activate</a> 
                                            <?php
                                        }
                                    ?>
