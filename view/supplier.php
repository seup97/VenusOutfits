<?php
    ...
    ///Activated supplier count
    include '../model/supplier_model.php';
    $supplierObj = new supplier();
 
    $activeResult= $supplierObj->getActiveSupplierCount();
    $activerow=$activeResult->fetch_assoc();
    
       ///  deactivated user count
    $deactiveResult= $supplierObj->getDeactiveSupplierCount();
                ...
                <div class="col-md-9">
                    <div class="col-md-6">
                        <div class="panel panel-default" style="background-color:#42f56c;color: #FFF;height:250px ">
                            ...
                            <h1 align="center">
                                <?php
                                    echo $activerow["activeSupplierCount"];
                                ?>
                            </h1>
                        </div>
                    </div>
