<?php
    ...
    $activeResult= $customerObj->getActiveCustomerCount();
    $activerow=$activeResult->fetch_assoc();
    
       ///  deactivated user count
    $deactiveResult= $customerObj->getDeactiveCustomerCount();
                ...
                <div class="col-md-9">
                    <div class="col-md-6">
                        <div class="panel panel-default" style="background-color:#42f56c;color: #FFF;height:250px ">
                            <h2 align="center">Activated Customers</h2>
                            <h1 align="center">
                                <?php
                                    echo $activerow["activeCustomerCount"];
                                ?>
                            </h1>
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="panel panel-default" style="background-color:#f5aa42;color: #FFF;height:250px ">
                            <h2 align="center">De Activated Customers</h2>
                            <h1 align="center">
                                <?php
                                    echo $deactiveCount;
                                ?>
