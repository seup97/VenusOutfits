...
class customer{
    ...
    public function addCustomer($fname, $lname, $address, $cno1,$cno2,$email,$nic,$country,$city,$state,$postalcode)
    {
        $conn= $GLOBALS["conn"];
        $sql="INSERT INTO customer(customer_fname,customer_lname,customer_address,customer_cno1,customer_cno2,customer_email,customer_nic,customer_country,customer_city,customer_state,customer_postalcode)VALUES"
                . "('$fname','$lname','$address','$cno1','$cno2','$email','$nic','$country','$city','$state','$postalcode')";
